...
<body class="js" >
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-2 col-md-2 col-12">
                        <!-- Logo -->
                        <div class="logo">
                            <a href="index.html"><img src="{{asset('front-end')}}/images/logo.png" alt="logo"></a>
                        </div>
                        <!--/ End Logo -->
                        <!-- Search Form -->
   ...
   <div>
                ...
                <div class="row">
                    <div class="col-lg-5 col-md-6 col-12">
                        ...
                        <div class="single-footer about">
                            <div class="logo">
                                <a href="index.html"><img src="{{asset('front-end')}}/images/logo2.png" alt="#"></a>
                            </div>
                ...
                <div class="inner">
                    <div class="row">
                        <div class="col-lg-6 col-12">
                            <div class="left">
                                <p>Copyright © 2021 <a href="" target="_blank"></a> Md Sofikul islam </p>
                            </div>
                        </div>
                        <div class="col-lg-6 col-12">
                            <div class="right">
    ...
    <!-- Color JS -->
    <script src="{{asset('front-end')}}/js/colors.js"></script>
    <!-- Slicknav JS -->
    ...
    <!-- Onepage Nav JS -->
    <script src="{{asset('front-end')}}/js/onepage-nav.min.js"></script>
    <!-- Easing JS -->
